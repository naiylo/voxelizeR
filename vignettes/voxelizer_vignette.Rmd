...
# Define the paths to the sample data
...
Now that we have our data loaded, we can proceed to voxelize the point cloud using the `voxelize` function. Voxelization is a process that divides a 3D space into a grid of cubes (voxels) and determines which points from the cloud fall within each voxel.
...
# Prepare tiles for voxelization
